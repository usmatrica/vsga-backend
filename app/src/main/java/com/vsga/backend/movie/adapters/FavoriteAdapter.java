...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.MovieViewHolder> {
    ...
    public FavoriteAdapter(Context context, List<MovieDetail> movieList) {
    ...
    public List<MovieDetail> getMovieData() {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        MovieDetail clickedDataItem = movieList.get(pos);
                        Intent intent = new Intent(context, MovieDetailActivity.class);
                        intent.putExtra(MovieDetailActivity.LOAD_TYPE, "favorite");
                        intent.putExtra(MovieDetailActivity.PARCELABLE_MOVIE, clickedDataItem);
